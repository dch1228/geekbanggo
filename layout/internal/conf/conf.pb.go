...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8f, 0x01, 0x0a, 0x09, 0x42, 0x6f,
	...
	0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xa3, 0x01, 0x0a, 0x06,
	0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x2e, 0x0a, 0x04, 0x67, 0x72, 0x70, 0x63, 0x18, 0x01,
	...
	0x74, 0x22, 0x7c, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x38, 0x0a, 0x08, 0x64, 0x61, 0x74,
	0x61, 0x62, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x69, 0x6e,
	...
	0x6f, 0x69, 0x6e, 0x74, 0x22, 0x7e, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79,
	0x12, 0x36, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x1e, 0x2e, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2e, 0x63, 0x6f, 0x6e, 0x66,
	...
	0x68, 0x65, 0x6d, 0x65, 0x42, 0x14, 0x5a, 0x12, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Registry)(nil),            // 4: internal.conf.Registry
	(*Server_GRPC)(nil),         // 5: internal.conf.Server.GRPC
	(*Data_Database)(nil),       // 6: internal.conf.Data.Database
	(*Registry_Consul)(nil),     // 7: internal.conf.Registry.Consul
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	5, // 3: internal.conf.Server.grpc:type_name -> internal.conf.Server.GRPC
	6, // 4: internal.conf.Data.database:type_name -> internal.conf.Data.Database
	7, // 5: internal.conf.Registry.consul:type_name -> internal.conf.Registry.Consul
	8, // 6: internal.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
