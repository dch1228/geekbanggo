...
func (tu *TodoUpdate) SetStatus(i int8) *TodoUpdate {
...
func (tu *TodoUpdate) AddStatus(i int8) *TodoUpdate {
...
// SetStatus sets the "status" field.
func (tuo *TodoUpdateOne) SetStatus(i int8) *TodoUpdateOne {
...
// AddStatus adds i to the "status" field.
func (tuo *TodoUpdateOne) AddStatus(i int8) *TodoUpdateOne {
